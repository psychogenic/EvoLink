/*
 * common.h -- External deps EvoLink, part of the
 ...
 * ************************* OVERVIEW *************************
 *
 * This file contains external dependencies common to all
 * platforms.
 */

#ifndef EVOLINK_DEPS_COMMON_H_
#define EVOLINK_DEPS_COMMON_H_
